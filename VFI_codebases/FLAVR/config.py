...
model_arg.add_argument('--eval_only' , type=int, default=0,help="Integer for running inference only")
...
misc_arg.add_argument('--set', type=str, default='main',choices=['high_afm','low_afm','high_alv','low_alv','high_arl','low_arl','high_arms','low_arms'])
